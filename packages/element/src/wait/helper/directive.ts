// Copied from `element-ui/packages/loading/src/directive.js`
...
import ElLoading from 'element-ui/packages/loading/src/loading.vue';

const Mask = Vue.extend(ElLoading);
...
function getDirective(): DirectiveOptions {
  return {
